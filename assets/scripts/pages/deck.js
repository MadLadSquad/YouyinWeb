...
function deckmain()
{
    ...
    runEventAfterAnimation($("new-card-button"), "click", function() { location.href = window.pageUrl("deck-edit-card", "?new") });
    runEventAfterAnimation($("new-phrase-button"), "click", function() { location.href = window.pageUrl("deck-edit-card", "?phrase-new") });
