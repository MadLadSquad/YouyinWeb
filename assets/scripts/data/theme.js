...
// Published URL of themes-data.js, injected by the build (see layouts/_partials/assets.html). This
// file is concatenated into the boot bundle, so document.currentScript.src no longer points at a
// sibling of the catalogue; the fingerprinted URL has to come from the asset pipeline instead.
const THEME_SCRIPT_SRC = "{{ .themesDataURL }}";
