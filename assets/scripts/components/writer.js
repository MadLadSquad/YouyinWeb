'use strict';
// hanzi-writer factory. Wraps the vendored HanziWriter with the site-wide defaults and reads stroke
// data straight from the in-memory window.characterData map (populated by character-database.js).
// Loaded only on the pages that draw characters (index/deck/deck-edit-card). HanziWriter and the
