...
window.startTutorialReplay = function ()
{
    ...
    window.location.href = window.pageUrl("index");
};
...
function tutDispatch()
{
    ...
    switch (step)
    {
        ...
        case TUT.createCard:
            ...
            else if (page === "deck") tutNavigate(window.pageUrl("deck-edit-card", "?new"));
            break;
        case TUT.cardReview:   if (page === "deck") tutRunCardReview(); break;
        case TUT.createPhrase:
            if (page === "deck-edit-card") tutRunCreatePhrase();
            else if (page === "deck") tutNavigate(window.pageUrl("deck-edit-card", "?phrase-new"));
            break;
