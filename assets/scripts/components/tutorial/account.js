...
//
// Bundled only into the account page's script bundle, ahead of the bootstrap() call, so these stage functions
...
async function tutRunAccount()
{
    ...
    tutRunTour([
        ...
        },
        {
            ...
            side: "top",
            onNext: () => { tutSetStep(TUT.outro); tutNavigate(window.pageUrl("index")); return false; },
        },
